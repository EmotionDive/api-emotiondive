...
def defining_grades_empatia(final_grade_empatia):
    ...
    if final_grade_empatia > 85:
        ...
        message_empatia ="Tienes la capacidad de entender las emociones de las demás personas, comprenderlas, quizá tienes la capacidad de ser una persona extrovertida, cooperativa y coordial, aunque puede que llegues a presentar dificultades al momento de comprender las emociones que tienes con los demás o el colaborar con ciertas personas que salen de tu entorno."
